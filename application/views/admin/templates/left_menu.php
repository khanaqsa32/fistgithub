    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="<?php echo ($page=='cutomer') ? 'active':''?>">
                    <a href="javascript:void(0)" aria-expanded="true"><i class="fa fa-photo"></i> <span class="nav-label">Customer</span> <span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse" aria-expanded="false" style="">
                        <li><a href="<?php echo BASE_URL_ADMIN.'Customer/add_customer';?>">Add Customer</a></li>
                        <li><a href="<?php echo BASE_URL_ADMIN.'Custom/listcutomer';?>">View Custom</a></li>
                    </ul>
                </li>
                ...
                <li class="<?php echo ($page=='news') ? 'active':''?>">
                    <a href="javascript:void(0)" aria-expanded="true"><i class="fa fa-book"></i> <span class="nav-label">News</span> <span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse" aria-expanded="false" style="">
                        <li><a href="<?php echo BASE_URL_ADMIN.'News/add_news';?>">Add News</a></li>
                        <li><a href="<?php echo BASE_URL_ADMIN.'News/listNews';?>">View News</a></li>
                    </ul>
                </li>
                <li class="<?php echo ($page=='student') ? 'active':''?>">
                    <a href="javascript:void(0)" aria-expanded="true"><i class="fa fa-book"></i> <span class="nav-label">Student</span> <span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse" aria-expanded="false" style="">
                        <li><a href="<?php echo BASE_URL_ADMIN.'Student/addStudent';?>">Add Student</a></li>
                        <li><a href="<?php echo BASE_URL_ADMIN.'Student/listStudent';?>">View Student</a></li>
                    </ul>
                </li>
